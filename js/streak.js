...
(function (CF) {
  ...
  S.hud = function () {
    if (this.off) { CF.HUD.setStreak(null); return; } // Story Campaign stealth: no drone to give you away
  ...
  S.onKill = function () {
    if (this.off || this.droneKill || this.ready || this.drones.length) return;
